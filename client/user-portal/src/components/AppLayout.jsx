          ...
          <div className="mobile-drawer-sheet flex flex-col h-full bg-white p-5" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-5 pb-4 border-b border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#FF5200] text-white flex items-center justify-center font-bold shadow-xs">
                  <UtensilsCrossed size={17} />
                </div>
                <div>
                  <div className="font-bold text-base text-slate-900 leading-tight">Dine@Bennett</div>
                  <div className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Campus Dining</div>
                </div>
              </div>
              <button
            ...
            {/* Current User Card */}
            <div className="p-3 rounded-xl bg-orange-50/50 border border-orange-100 mb-5">
              <div className="flex items-center gap-3">
                <img
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs font-semibold text-[#FF5200] truncate">
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge > 0 && (
                      <span className="ml-auto px-2 py-0.5 rounded-full text-xs font-bold bg-white text-[#FF5200]">
                        {item.badge}
                      </span>
                    )}
                  </NavLink>
